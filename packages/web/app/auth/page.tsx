  ...
  return (
    <>
      ...
      <CardFooter className='flex-col'>
        <Button className="w-full mb-2" onClick={()=>Router.push('/stepform')}>Create account</Button>
        <Button className="w-full" variant={'secondary'}  onClick={() => setsigninpage(!signinpage)}>Already a Registered User ? SignIn.</Button>
      </CardFooter>
    </Card>
    </>
  );
...
const Signin = ({setsigninpage, signinpage}) => {
  ...
  return (
    <>
      ...
      <CardFooter className='flex-col'>
        <Button className="w-full mb-2" onClick={()=>Router.push('/stepform')}>Login</Button>
        <Button className="w-full" variant={'secondary'}  onClick={() => setsigninpage(!signinpage)}>Not a Registered User ? SignUp.</Button>
      </CardFooter>
    </Card>
    </>
  );
